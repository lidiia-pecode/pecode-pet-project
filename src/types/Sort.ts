...
export const SORT_OPTIONS_DROPDOWN = {
  REVIEWS_DESC: SORT_OPTIONS.REVIEWS_DESC,
  RATING_DESC: SORT_OPTIONS.RATING_DESC,
  PRICE_ASC: SORT_OPTIONS.PRICE_ASC,
  PRICE_DESC: SORT_OPTIONS.PRICE_DESC,
} as const;

export type SortOption = (typeof SORT_OPTIONS)[keyof typeof SORT_OPTIONS];

export type SortOptionDropdown = (typeof SORT_OPTIONS_DROPDOWN)[keyof typeof SORT_OPTIONS_DROPDOWN];

export const SORT_LABELS: Record<SortOptionDropdown, string> = {
  [SORT_OPTIONS.REVIEWS_DESC]: 'Most popular',
